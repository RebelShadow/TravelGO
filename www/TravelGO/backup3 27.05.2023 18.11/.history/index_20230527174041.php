...
<section class="recent-reviews">
    <div class="container">
      ...
      <div class="swiper-container recent-reviews-slider">
        <div class="swiper-wrapper">
          <?php
          $servername = "localhost";
          $username = "root";
          ...
          $query = "SELECT r.restaurant_name, r.restaurant_image, rv.*, u.username FROM review rv
          ...
          if ($result) {
            ...
            if (mysqli_num_rows($result) > 0) {
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="swiper-slide">';
                echo '<img src="data:image/jpeg;base64,' . base64_encode($restaurantImage) . '" alt="Restaurant Image" width="100" height="100">';
                echo '<p>Restaurant Name: ' . $restaurantName . '</p>';
                echo '<p>' . $username . '</p>';
                echo '<p>' . $title . '</p>';
                echo '<p>' . $stars . ' stars</p>';
                echo '<p>' . $body . '</p>';
                echo '<p>Created At: ' . $createdAt . '</p>';
                echo '<form action="restaurant.php" method="GET">';
                echo '<input type="hidden" name="restaurant_id" value="' . $reviewId . '">';
                echo '<input type="submit" value="View Restaurant">';
                echo '</form>';
                echo '</div>';
              }
            } else {
