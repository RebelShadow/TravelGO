...
$query = "SELECT r.restaurant_name, r.restaurant_image, rv.*, u.username, rr.restaurant_id FROM review rv
          ...
          ORDER BY rv.created_at DESC LIMIT 4"; // Change the limit (5) as per your requirement
...
if ($result) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='submit'class='view-button' value='View Restaurant'>";
            echo "</form>";
            echo "</div>";
        }
    } else {
...
?>
  ...
  <footer>
    <p>&copy; 2023 TravelGO. All rights reserved. | Designed by Andrei Bogdan</p>
  </footer>
