<!DOCTYPE html>
<html lang="en-US">
//TODO fix the picture problem (maybe because there are no pictures in the database or php not working corectly)
<head>
  <meta charset="UTF-8">
    ...
    <div class="container">
      ...
      <div class="restaurant-grid">
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
          ...
          echo '<img src="data:image/jpeg;base64,' . base64_encode($row['restaurant_image']) . '" alt="' . $name . '">';
          echo '<h3>' . $name . '</h3>';
