...
// Query to retrieve the most recent reviews
$query = "SELECT * FROM review ORDER BY created_at DESC LIMIT 5"; // Change the limit (5) as per your requirement
...
if ($result) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // Add the button for redirecting to the restaurant
