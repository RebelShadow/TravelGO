...
<section class="recent-reviews">
  <div class="container">
    ...
    $stmt = $conn->prepare("SELECT r.restaurant_name, rv.review_text, rv.author_name FROM review AS rv INNER JOIN restaurant AS r ON rv.restaurant_id = r.restaurant_id ORDER BY rv.review_id DESC LIMIT 2");
    $stmt->execute();
